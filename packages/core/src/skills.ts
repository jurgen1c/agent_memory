...
Query, context, show and audit default to format ${options.config.retrieval?.default_format_version ?? 1} in this repository. Explicit \`--format-version 1\` or \`--format-version 2\` overrides the default. In v2, inspect taskMatches, completeness, warnings, budget.omitted and suggested_not_run commands; do not assume the legacy JSON shape.
